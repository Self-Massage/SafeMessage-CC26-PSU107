...
with st.sidebar:
    st.markdown("# 📩🔐")
    st.markdown("""
        <h3 style='margin-bottom:0px; font-family: "Source Sans Pro", sans-serif; font-weight:700;'>
            Dashboard Exploratory Data Analysis (EDA)
        </h3>
        <p style='font-size:12px; color:gray; margin-top:4px;'>Deteksi Phishing SMS Berbahasa Indonesia</p>
